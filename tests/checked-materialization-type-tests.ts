import type { EntityMaterializationRow } from '../packages/core/src';
...
row.required(user => user.misspelled); // eslint-disable-line @typescript-eslint/no-unsafe-return -- Intentional invalid selector.
